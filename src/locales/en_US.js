...
const strings = {
  ...
  edge_description: 'This application would like to create or access its wallet in your vCASH account.\n\n It will not have access to any other wallets.',
  ...
  send_scan_header_text: 'Scan, to Send, import, or vCASH Login',
  send_to_title: 'To:',
  ...
  title_kiosks_location: 'Kiosk\'s Location',
  title_send: 'Send',
